...
class AuthorityPaymentAccounts(models.Model):
    ...
    icon_security_auth_username = models.CharField(db_column="paymentUserName", max_length=255, blank=True)
    icon_security_auth_password = models.CharField(db_column="paymentPassword", max_length=255, blank=True)
